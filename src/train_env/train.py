...
if __name__ == '__main__':
    # Create directories where model date will be saved.
    pathlib.Path('../../models/tmp/nets').mkdir(exist_ok=True)
    pathlib.Path('../../models/tmp/plots').mkdir(exist_ok=True)
